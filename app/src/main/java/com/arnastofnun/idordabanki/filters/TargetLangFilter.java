 ...
 * @since 3/19/15.
 */
public final class TargetLangFilter implements Predicate<Result> {
     ...
     */
    public TargetLangFilter(final String regex){
    ...
    public boolean apply(final Result input){
        return pattern.matcher(input.getLanguage_code()).find();
    }
}
